...
It renames all the occurrences of risk_attention (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the risk_attention folder
        os.rename(
            os.path.join(root_dir_path, "exts", "risk_attention", "risk_attention"),
            os.path.join(root_dir_path, "exts", "risk_attention", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "risk_attention"), os.path.join(root_dir_path, "exts", new_name))
